		...
		protected override void OnRenderUI( GuiRenderer renderer )
		{
			...
			foreach( Entity entity in Map.Instance.Children )
			{
				...
				if( piece != null )
				{
					...
					{
						Vec2 screenPosition;
						RendererWorld.Instance.DefaultCamera.ProjectToScreenCoordinates(
			...
			if( GameNetworkServer.Instance != null || GameNetworkClient.Instance != null )
			{
				...
				renderer.AddTextLines( lines, new Vec2( .01f, .15f ),
					new Vec2( 0, renderer.DefaultFont.Height ), HorizontalAlign.Left,
					VerticalAlign.Top, new ColorValue( 1, 1, 0 ) );
			}
