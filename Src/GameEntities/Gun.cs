...
namespace GameEntities
{
	...
	public class GunType : WeaponType
	{
		...
		protected override void OnPreloadResources()
		{
			...
			if( !string.IsNullOrEmpty( SoundReload ) )
				SoundWorld.Instance.SoundCreate( SoundReload, SoundMode.Mode3D );
			if( !string.IsNullOrEmpty( SoundEmpty ) )
				SoundWorld.Instance.SoundCreate( SoundEmpty, SoundMode.Mode3D );
		}
